export default function DusunSukamandiPage() {
  return (
    <div className="py-16 bg-white min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Dusun Sukamandi</h1>
        ...
        <div className="bg-gray-50 p-8 rounded-xl border border-gray-200 mb-8">
          <h2 className="text-2xl font-semibold text-gray-900 mb-4">Tentang Dusun Sukamandi</h2>
          <p className="text-gray-700 leading-relaxed">
            Dusun Sukamandi merupakan salah satu dusun di Desa Gombong, Kecamatan Ciawi, Kabupaten Tasikmalaya. 
            Dusun ini dikenal dengan masyarakatnya yang gotong royong dan memiliki potensi pertanian yang baik.
          </p>
        </div>
        ...
        <div className="bg-white border-2 border-[#437118] p-8 rounded-xl mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <p className="text-3xl font-bold text-blue-600">418 jiwa</p>
            </div>
            <div className="bg-pink-50 p-6 rounded-lg">
              ...
              <p className="text-3xl font-bold text-pink-600">421 jiwa</p>
            </div>
            <div className="bg-green-50 p-6 rounded-lg">
              ...
              <p className="text-3xl font-bold text-green-600">839 jiwa</p>
            </div>
            <div className="bg-orange-50 p-6 rounded-lg">
              ...
              <p className="text-3xl font-bold text-orange-600">303 KK</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600">Bagian dari Pemerintahan Desa Gombong di bawah Kepala Dusun Tita Sholihatul Muniroh Hilmi, S.E</p>
              </div>
            </div>
          </div>
        </div>
