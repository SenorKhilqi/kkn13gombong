export default function DusunPananyungPage() {
  return (
    <div className="py-16 bg-white min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Dusun Pananyung</h1>
        ...
        <div className="bg-gradient-to-br from-[#437118] to-blue-600 text-white p-8 rounded-xl shadow-lg mb-8">
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">Amat Bongsor</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-50 p-8 rounded-xl border border-gray-200 mb-8">
          <h2 className="text-2xl font-semibold text-gray-900 mb-4">Tentang Dusun Pananyung</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600">Bagian dari Pemerintahan Desa Gombong di bawah Kepala Dusun Amat Bongsor</p>
              </div>
            </div>
          </div>
        </div>
