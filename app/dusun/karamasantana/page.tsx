export default function DusunKaramasantanaPage() {
  return (
    <div className="py-16 bg-white min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Dusun Karamasantana</h1>
        ...
        <div className="bg-gray-50 p-8 rounded-xl border border-gray-200 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Dusun Karamasantana merupakan salah satu dusun di Desa Gombong, Kecamatan Ciawi, Kabupaten Tasikmalaya. 
            Dusun ini memiliki kehidupan masyarakat yang harmonis dengan adat dan budaya lokal yang masih terjaga.
          </p>
        </div>
        ...
        <div className="bg-white border-2 border-[#437118] p-8 rounded-xl mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <p className="text-3xl font-bold text-blue-600">216 jiwa</p>
            </div>
            <div className="bg-pink-50 p-6 rounded-lg">
              ...
              <p className="text-3xl font-bold text-pink-600">194 jiwa</p>
            </div>
            <div className="bg-green-50 p-6 rounded-lg">
              ...
              <p className="text-3xl font-bold text-green-600">410 jiwa</p>
            </div>
            <div className="bg-orange-50 p-6 rounded-lg">
              ...
              <p className="text-3xl font-bold text-orange-600">148 KK</p>
            </div>
          </div>
          <div className="mt-6 bg-gray-50 p-6 rounded-lg">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-700">RW 001 (RT 001-003)</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600">Bagian dari Pemerintahan Desa Gombong di bawah Kepala Dusun Enjang Hadi Hidayah</p>
              </div>
            </div>
          </div>
        </div>
