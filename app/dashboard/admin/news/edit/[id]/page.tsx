...
import { updateNewsWithImage } from '@/app/actions/news';
...
export default function EditNewsPage({ params }: PageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = await updateNewsWithImage(id, submitFormData);
                    ...
                    <div className="flex items-center justify-center w-full px-4 py-6 border-2 border-dashed border-gray-300 rounded-lg hover:border-[#437118] transition-colors cursor-pointer">
                      <div className="text-center">
                        ...
                        <p className="mt-2 text-sm text-gray-600">
                          <span className="font-semibold">Upload gambar baru</span> atau drag & drop
                        </p>
